...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryColor = const Color(0xFFEBA844);
  late Color tertiaryColor = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF000D);
  late Color primaryBackground = const Color(0xFFE9E9E9);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiaryColor = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFFF0011);
