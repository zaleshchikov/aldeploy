...
class PageCatalogWidget extends StatefulWidget {
  const PageCatalogWidget({Key? key, this.categoryId}) : super(key: key);
  final String? categoryId;

  @override
  _PageCatalogWidgetState createState() => _PageCatalogWidgetState();
}

class _PageCatalogWidgetState extends State<PageCatalogWidget> {
  ...
  void initState() {
    ...
    futureProducts =
        fetchProductsOneType(FFAppState().currentShopId, widget.categoryId!);
    print(FFAppState().currentShopId);
                                ...
                                child: Padding(
                                  ...
                                  child: FutureBuilder<List<Product>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      _found = _found
                                        ..where((product) =>
                                            product.sellPricePerUnit != null &&
                                            product.hide == false).toList();

                                      _found.sort((product1, product2) {
                                        int? productRest1 =
                                            product1.productRest == null
                                                ? 0
                                                : product1.productRest;
                                        int? productRest2 =
                                            product2.productRest == null
                                                ? 0
                                                : product2.productRest;
                                        if (productRest1! > productRest2!) {
                                          return -1;
                                        } else if (productRest1 <
                                            productRest2) {
                                          return 1;
                                        } else {
                                          return 0;
